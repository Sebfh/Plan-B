...
var nav = navigator,
	...
	intl = {
		...
		en_us: 'Install PlanB on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
		...
		nl_nl: 'Installeer PlanB op uw %device: tik %icon en dan <strong>Zet in beginscherm</strong>.',
